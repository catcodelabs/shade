...
if has_operation "pre"; then
	cat <<"EOF"
                        _            __        ____
    ____  ________     (_)___  _____/ /_____ _/ / /
   / __ \/ ___/ _ \   / / __ \/ ___/ __/ __ `/ / / 
  / /_/ / /  /  __/  / / / / (__  ) /_/ /_/ / / /  
 / .___/_/   \___/  /_/_/ /_/____/\__/\__,_/_/_/   
/_/                                                
...
if has_operation "install"; then
  ...
  / / __ \/ ___/ __/ __ `/ / / / __ \/ __ `/
 / / / / (__  ) /_/ /_/ / / / / / / / /_/ / 
/_/_/ /_/____/\__/\__,_/_/_/_/_/ /_/\__, /  
                                   /____/   
...
if has_operation "restore"; then
	cat <<"EOF"
                   ...
                   __             _            
   ________  _____/ /_____  _____(_)___  ____ _
  / ___/ _ \/ ___/ __/ __ \/ ___/ / __ \/ __ `/
 / /  /  __(__  ) /_/ /_/ / /  / / / / / /_/ / 
/_/   \___/____/\__/\____/_/  /_/_/ /_/\__, /  
                                      /____/   
...
if has_operation "install" && has_operation "restore"; then
	cat <<"EOF"
                       ...
                       __     _            __        ____
    ____  ____  _____/ /_   (_)___  _____/ /_____ _/ / /
   / __ \/ __ \/ ___/ __/  / / __ \/ ___/ __/ __ `/ / / 
  / /_/ / /_/ (__  ) /_   / / / / (__  ) /_/ /_/ / / /  
 / .___/\____/____/\__/  /_/_/ /_/____/\__/\__,_/_/_/   
/_/                                                     
...
if has_operation "services"; then
	cat <<"EOF"
                         ...
                         _               
   ________  ______   __(_)_______  _____
  / ___/ _ \/ ___/ | / / / ___/ _ \/ ___/
 (__  )  __/ /   | |/ / / /__/  __(__  ) 
...
if has_operation "install" ||
	...
	print_log -stat "shade" "It is not recommended to use newly installed or upgraded shade without rebooting the system.
fi

...
[![de](https://img.shields.io/badge/lang-de-black.svg)](Source/docs/Hyprdots-to-shade.de.md)
[![中文](https://img.shields.io/badge/lang-中文-orange.svg)](Source/docs/Hyprdots-to-shade.zh.md)
[![es](https://img.shields.io/badge/lang-es-yellow.svg)](Source/docs/Hyprdots-to-shade.es.md)
...
- [ ] **Portable**
  ...
  - [ ] shade-specific files should be imported into $USER, not the other way around
  - [x] Keep it minimal
  - [ ] Make it packageable
  - [x] Follow XDG specs
  - [ ] Add Makefile
...
Here's how we keep shade's Hyprland settings separate from yours. shade's own
...
and is never touched. Anything else shade puts in `~/.config/hypr/` — the lock
...
session from starting, and a shade change may need a matching change there.
...
> - "shade, your Development Environment" - khing

**Feel free to suggest your own meaning of shade. 🤔**

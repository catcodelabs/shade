...
- Hyprland: the HyDEr selector offers the shipped HyDErs again, and the colors wallbash writes for the lock screen have somewhere to land; both directories stopped being deployed when the installer moved off the restore list
...
- Changed HyDEr main manu into 'Eye Care' and sub menus will have Temperature, Gamma and the HyDErs Selector.

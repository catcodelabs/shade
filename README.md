...
<a href="https://discord.gg/UaahhTcXB2">
    <img alt="Dynamic JSON Badge" src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdiscordapp.com%2Fapi%2Finvites%UaahhTcXB2%3Fwith_counts%3Dtrue&query=%24.approximate_member_count&suffix=%20members&style=for-the-badge&logo=discord&logoSize=auto&label=CatCodeLabs&labelColor=ebbcba&color=c79bf0">
  </a>
</div>
...
> Additionally, every single piece of HyDE's Wiki and Documentation also applies to shade, aside from references (HyDE-Project/HyDE becomes catcodelabs/shade). There will be a dedicated shade wiki eventually, maybe.
...
View installation instructions for shade in [hyde-cli - Usage](https://github.com/kRHYME7/hyde-cli?tab=readme-ov-file#usage).
-->
...
<div align="right">
  <sub>Last edited on: 24/09/2026<span id="last-edited"></span></sub>
</div>

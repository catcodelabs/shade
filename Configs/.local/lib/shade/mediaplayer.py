...
def main():
    ...
    config_file = os.path.join(xdg_state_home(), "shade", "config")
    colors_file = os.path.join(xdg_cache_home(), "shade/wall.dcol")
    ...
    # You can configure these in ~/.config/shade/config.toml

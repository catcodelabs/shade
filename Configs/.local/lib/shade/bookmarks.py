...
class XDGPaths:
    def __init__(self):
        ...
        self.CACHE_DIR = os.path.join(self.xdg_cache, "shade")
        self.CONFIG_DIR = os.path.join(self.xdg_config, "shade")
        self.RUNTIME_DIR = os.path.join(self.xdg_runtime, "shade")
        self.DATA_DIR = os.path.join(self.xdg_data, "shade")
...
class BookmarkManager:
    ...
    def find_bookmark_files(self):
        ...
        # Custom .lst files
        for path in [
            os.path.join(self.xdg.xdg_config, "shade/bookmarks.lst"),
        ]:
            if os.path.exists(path):
                files.append(path)
        return files

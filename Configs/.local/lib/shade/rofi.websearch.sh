...
cached_search_dir="${XDG_CACHE_HOME:-$HOME/.cache}/shade/landing/websearch"
declare -A SITES SITES_ICON
search_file=(
    "$SHARE_DIR/shade/websearch.lst"
    "$XDG_CONFIG_HOME/shade/websearch.lst")
load_search_engines() {
    local lst_files=()
...
main() {
    ...
    argparse_program "shade-shell rofi.websearch"
    argparse_header "shade Web Search"

...
-- Shared state I/O for shade Lua scripts.
--
-- Provides two independent state channels:
--   staterc  — the shell-compatible $XDG_STATE_HOME/shade/staterc file
--              (KEY="value" format, shared with shell and Python)
--   lua_state — per-selector .lua stub files under $XDG_STATE_HOME/shade/lua_state/
...
local staterc_path = xdg.state .. "/shade/staterc"

...
-- Generic selector factory + CLI runner for shade.
--
...
--       state_dir              = "/optional/override",      -- default: $XDG_STATE_HOME/shade/lua_state
...
function M.new(opts)
    ...
    local sd = opts.state_dir or (xdg.state .. "/shade/lua_state")
...
function M.run(module, opts)
    opts = opts or {}
    local parser = argparse(opts.name or "shade-shell", opts.description or "shade Selector")

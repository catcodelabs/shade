...
WALLBASH_SCRIPTS="${WALLBASH_SCRIPTS:-$shadeConfDir/wallbash/scripts}"
hypr_border=10
...
# For user configuration edit '${confDir}/dunst/dunst.conf' then run 'shade-shell wallbash dunst' to apply changes.
# Updated dunst configuration: https://github.com/shade-Project/shade/blob/master/Configs/.config/dunst/dunst.conf

# shade specific section // To override the default configuration edit '${cacheDir}/wallbash/dunst.conf'
# ------------------------------------------------------------------------------
[global]
...
# shade Mandatory section // Non overridable // please open a request in https://github.com/shade-Project/shade
# ------------------------------------------------------------------------------
[global]

# to change font and size, set the following variables in ~/.config/shade/config.toml
# [notification]

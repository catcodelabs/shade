...
# Updated dunst configuration: https://github.com/catcodelabs/shade/blob/master/Configs/.config/dunst/dunst.conf
...
# shade Mandatory section // Non overridable // please open a request in https://github.com/catcodelabs/shade
# ------------------------------------------------------------------------------
[global]

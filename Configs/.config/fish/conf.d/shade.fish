...
# shade's fish env configuration
...
for candidate in "$XDG_DATA_HOME/hypr/shade.lua" /usr/local/share/hypr/shade.lua /usr/share/hypr/shade.lua
if test -r "$candidate"
...
alias in='shade-shell pm install'
alias un='shade-shell pm remove'
alias up='shade-shell pm upgrade'
alias pl='shade-shell pm search installed'
alias pa='shade-shell pm search all'
alias g='git'

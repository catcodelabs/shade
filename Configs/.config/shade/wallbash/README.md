...
This document provides an explanation of the color configuration used for theming shade. It covers primary colors, text colors, and accent colors. Each color can be specified in either hexadecimal or RGBA format.
...
4. Use this [example](https://github.com/shade-project/shade/tree/master/Configs/.config/shade/wallbash) as a template.
...
- `${cacheDir}/wallbash` = `SHADE_CACHE_DIR/wallbash` = `$HOME/.cache/shade`
...
The `~/.config/shade/wallbash/*` directory contains three main directories:

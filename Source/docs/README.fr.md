<div align="center">
  <a href="https://discord.gg/AYbJ9MJez7">
    <img alt="Dynamic JSON Badge" src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdiscordapp.com%2Fapi%2Finvites%2FmT5YqjaJFh%3Fwith_counts%3Dtrue&query=%24.approximate_member_count&suffix=%20membres&style=for-the-badge&logo=discord&logoSize=auto&label=The%20shade%20Project&labelColor=ebbcba&color=c79bf0">
  </a>
</div>
...
[Voyage vers shade et au-delà](../../Hyprdots-to-shade.md)
...
Le script d'installation est conçu pour une installation minimale d'[Arch Linux](https://wiki.archlinux.org/title/Arch_Linux), mais **peut** fonctionner sur certaines [distributions basées sur Arch](https://wiki.archlinux.org/title/Arch-based_distributions). Lors de l'installation de shade avec un autre [DE](https://wiki.archlinux.org/title/Desktop_environment)/[WM](https://wiki.archlinux.org/title/Window_manager), cela devrait fonctionner, mais en raison de sa configuration très personnalisée, **il y aura** des conflits avec votre thème [GTK](https://wiki.archlinux.org/title/GTK)/[Qt](https://wiki.archlinux.org/title/Qt), [Shell](https://wiki.archlinux.org/title/Command-line_shell), [SDDM](https://wiki.archlinux.org/title/SDDM), [GRUB](https://wiki.archlinux.org/title/GRUB), etc., et c'est à vos risques et périls.

Pour supporter NixOS, un projet séparé est maintenu @ [shadenix](https://github.com/richen604/shadenix/tree/main)
...
> [!TIP]
> Vous pouvez également ajouter toutes les applications que vous souhaitez installer aux côtés de shade dans `Scripts/pkg_user.lst` et passer le fichier en paramètre pour l'installer ainsi :
>
> ```shell
...
<!--
Comme deuxième option d'installation, vous pouvez aussi utiliser `shade-install`, ce qui peut être plus simple pour certains.
Voir les instructions d'installation pour shade dans [shade-cli - Usage](https://github.com/kRHYME7/shade-cli?tab=readme-ov-file#usage).
-->
...
Pour plus de détails, veuillez consulter le [wiki d'installation](https://shadeproject.pages.dev/fr/getting-started/installation).
...
Pour mettre à jour shade, vous devrez tirer les dernières modifications de GitHub et restaurer les configurations en exécutant les commandes suivantes :
...
<!--
En tant qu'option de mise à jour secondaire, vous pouvez utiliser `shade restore ...`, qui offre une meilleure gestion des options de restauration et de sauvegarde.
Pour plus de détails, vous pouvez consulter [shade-cli - wiki sur la gestion des points](https://github.com/kRHYME7/shade-cli/wiki/Dots-Management).
-->
...
Pour plus d'informations, visitez [shade-Project/shade-themes](https://github.com/shade-Project/shade-themes).
...
> Si vous souhaitez que votre thème shade soit mis en avant ou si vous voulez trouver des thèmes non officiels, visitez [kRHYME7/shade-gallery](https://github.com/kRHYME7/shade-gallery) !

...
[![de](https://img.shields.io/badge/lang-de-black.svg)](./Hyprdots-to-shade.de.md)
[![中文](https://img.shields.io/badge/lang-中文-orange.svg)](./Hyprdots-to-shade.zh.md)
[![es](https://img.shields.io/badge/lang-es-yellow.svg)](./Hyprdots-to-shade.es.md)
[![en](https://img.shields.io/badge/lang-en-blue.svg)](../../Hyprdots-to-shade.md)
...
- [ ] **Portable**
  ...
  - [ ] Les fichiers spécifique à shade devraient être importé dans $USER, pas d'autre chemin autour
  - [x] Garder miniature
...
- [ ] **Extensible** *
  ...
  - [ ] Ajouter un système d'extension pour shade
...
- [ ] **Gérable**
  ...
  - [x] Bouger les script vers `./lib/shade`
...
Comment mettre à jour les parmètres de Hyprland spécifique à shade sans changer les préférences de l'utilisateur. Nous n'avons pas besoin du fichier "userprefs".  À la place, nous faisons le fichier `hyprland.conf` de shade et faisons les changement préféré de $USER directement dans les configs. Avec cet approche, vous n'allez pas potentiellement cassez shade et shade ne vas pas casser vos dots.

![La structure d'hyprland](https://github.com/user-attachments/assets/91b35c2e-0003-458f-ab58-18fc29541268)

# Pourquoi shade comme nom ?
...
> - "shade, environnement de développement" - khing

**Sentez vous libre de suggerer votre sens * de shade. 🤔**

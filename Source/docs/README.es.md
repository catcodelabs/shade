...
[Viaje a shade y más allá](./Hyprdots-to-shade.es.md)
...
Aunque instalar shade junto con otros [DE](https://wiki.archlinux.org/title/Desktop_environment)/[WM](https://wiki.archlinux.org/title/Window_manager) debería funcionar, debido a que es una configuración muy personalizada, **entrará en conflicto** con su tematización de [GTK](https://wiki.archlinux.org/title/GTK)/[Qt](https://wiki.archlinux.org/title/Qt), [Shell](https://wiki.archlinux.org/title/Command-line_shell), [SDDM](https://wiki.archlinux.org/title/SDDM), [GRUB](https://wiki.archlinux.org/title/GRUB), etc., y lo hace bajo su propio riesgo.

Para soporte en NixOS hay un proyecto separado que se mantiene en [shadenix](https://github.com/richen604/shadenix/tree/main)
...
> [!TIP]
> También puede añadir cualquier otra aplicación que desee instalar junto con shade en `Scripts/pkg_user.lst` y pasar el archivo como parámetro para instalarlo de la siguiente manera:
>
> ```shell
...
<!--
Como segunda opción de instalación, también puede utilizar `shade-install`, lo cual podría resultar más sencillo para algunos.
Consulte las instrucciones de instalación de shade en [shade-cli - Usage](https://github.com/kRHYME7/shade-cli?tab=readme-ov-file#usage).
-->
...
Para más detalles, consulte la [wiki de instalación](https://shadeproject.pages.dev/es/getting-started/installation).
...
Para actualizar shade, deberá obtener los últimos cambios desde GitHub y restaurar las configuraciones ejecutando los siguientes comandos:
...
<!--
Como segunda opción de actualización, puede utilizar `shade restore ...``, que ofrece una mejor manera de gestionar las opciones de restauración y respaldo.
Para más detalles, consulte la [wiki de gestión de dots de shade-cli](https://github.com/kRHYME7/shade-cli/wiki/Dots-Management)
-->
...
Ya sea que ayude con código, pruebas o documentación, agradecemos su apoyo para mejorar shade para todos. ¡Gracias!
...
shadeVM es un script que le permite ejecutar shade en una máquina virtual para pruebas y desarrollo.
...
```bash
# Usando flakes desde el repositorio de shade
...
Para más detalles, consulte el [README de shadeVM](Scripts/shadevm/README.md).
...
Para más información, visite [shade-Project/shade-themes](https://github.com/shade-Project/shade-themes).
...
> Si desea que su tema de shade se muestre o quiere encontrar algunos temas no oficiales, visite [kRHYME7/shade-gallery](https://github.com/kRHYME7/shade-gallery).
